...
%JAVA% -Dspring.config.location="file:%SERVICE_HOME%\config\application.yml" %JAVA_OPTS% %JAVA_OPTS_SCRIPT% -cp %SERVICE_HOME%\lib\* cxy.example.ConfigCenterApp >> %LOG_STDOUT_FILE% &
